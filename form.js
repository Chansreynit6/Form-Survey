...
console.log(gradeValues);
    ...
    for(let i=0 ; i< checked1.length; i++){
        ...
        if(checked1[i].checked){
            checked1Value.push(checked1[i].nextElementSibling.textContent.trim(),checked1[i].value);
        }
    }
...
console.log(yes3Value);
    ...
    for(let i=0 ; i< checked2.length; i++){
        console.log(checked2[i].nextElementSibling.textContent.trim(),checked2[i].checked);
